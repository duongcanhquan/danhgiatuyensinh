...
Đếm **lần chuyển nhãn trong ngày/kỳ** (không phải tổng số hồ sơ đang WARM):

- **WARM+:** nhãn chuyển **sang WARM** (từ trạng thái khác, không tính từ HOT).
- **HOT+:** nhãn chuyển **sang HOT**.
...
**Điểm tháng (0–100)** trên Bảng điểm = tổng có trần từng nhóm:

| Thành phần | Mặc định (có thể đổi) |
|------------|------------------------|
| Gọi HL | Trần 20 điểm — đạt khi ~120 HL/tháng |
| WARM+ + HOT+ | Trần 15 — 2 điểm / lần chuyển |
| Cọc | Trần 25 — 5 điểm / cọc duyệt |
| Doanh thu | Trần 30 — theo mẫu 50 triệu VND |
| NEW → Quan tâm | Trần 10 — 1 điểm / lần |

**Hạng Vàng / Bạc / Đồng:** xếp theo **doanh thu duyệt** trong tháng (phần trăm xếp hạng tích lũy — mặc định top 10% / 35% / 65%).
