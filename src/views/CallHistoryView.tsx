  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-wrap items-end gap-3">
        ...
        {(canTeam || canGlobal) && (
          <div className="app-tab-segmented scroll-touch flex flex-wrap gap-0.5">
            {can('dashboard:counselor') ? (
              <button
                type="button"
                onClick={() => setViewMode('self')}
                className="app-tab-segmented-btn"
                data-active={viewMode === 'self' ? 'true' : 'false'}
              >
                Cá nhân
              </button>
            ) : null}
            {canTeam ? (
              <button
                ...
                className="app-tab-segmented-btn"
                data-active={viewMode === 'team' ? 'true' : 'false'}
              >
                Nhóm
              </button>
            ) : null}
            {canGlobal ? (
              <button
                ...
                className="app-tab-segmented-btn"
                data-active={viewMode === 'global' ? 'true' : 'false'}
              >
                Toàn trường
              </button>
            ) : null}
