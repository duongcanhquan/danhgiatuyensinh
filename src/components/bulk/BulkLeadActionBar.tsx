          ...
          <div className="app-modal flex flex-wrap items-center justify-between gap-3 rounded-2xl px-3 py-3 sm:px-4">
            <div className="flex min-w-0 flex-1 items-center gap-2 sm:gap-3">
              ...
              <button
                type="button"
                onClick={onClear}
                className="min-h-11 min-w-11 shrink-0 cursor-pointer rounded-lg border border-slate-200/90 bg-white/50 p-2 text-slate-500 transition hover:border-rose-300 hover:bg-rose-50 hover:text-rose-700"
            ...
            <div className="flex w-full flex-wrap gap-2 sm:w-auto sm:justify-end">
              ...
              {onBulkPriorityTag ? (
                <button
                  ...
                  className="inline-flex min-h-11 flex-1 cursor-pointer items-center justify-center gap-2 rounded-xl border border-sky-300 bg-sky-50 px-3 py-2.5 text-sm font-semibold text-sky-950 transition hover:border-sky-400 hover:bg-sky-100 sm:flex-initial sm:min-h-10"
                >
              ...
              {showReassign ? (
                <button
                  type="button"
                  onClick={onReassign}
                  className="inline-flex min-h-11 flex-1 cursor-pointer items-center justify-center gap-2 rounded-xl border border-violet-300 bg-violet-100/90 px-3 py-2.5 text-sm font-semibold text-violet-900 transition hover:border-violet-400 hover:bg-violet-100 sm:flex-initial sm:min-h-10"
                >
              ...
              <button
                ...
                className="inline-flex min-h-11 flex-1 cursor-pointer items-center justify-center gap-2 rounded-xl border border-amber-300 bg-amber-50 px-3 py-2.5 text-sm font-semibold text-amber-900 transition hover:border-amber-400 hover:bg-amber-100 sm:flex-initial sm:min-h-10"
              >
              ...
              {onBulkDelete ? (
                <button
                  ...
                  className="inline-flex min-h-11 flex-1 cursor-pointer items-center justify-center gap-2 rounded-xl border border-rose-400 bg-rose-600 px-3 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-rose-700 sm:flex-initial sm:min-h-10"
                >
