...
const BASE_TEMPLATES: RuleLibraryTemplate[] = [
  ...
  {
    key: 'acad-high-school-list',
    category: 'academic',
    title: 'Danh sách trường THPT (ưu tiên)',
    hint: 'CONTAINS — tên trường cách nhau bởi dấu phẩy; đọc từ Trường THPT trên hồ sơ',
    build: () =>
      makeBlock({
        category: 'academic',
        label: 'Trường THPT ưu tiên',
        targetField: 'highSchool',
        maxWeight: 40,
        rows: [
          row({
            condition: 'CONTAINS',
            value: 'THPT Chương Mỹ B, THPT Phú Xuyên B',
            allocationKind: 'absolute',
            allocationValue: 40,
          }),
        ],
