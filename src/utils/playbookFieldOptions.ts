...
export const PLAYBOOK_FIELD_OPTIONS: { value: PlaybookConditionField; label: string }[] = [
  ...
  { value: 'educationLevel', label: 'Hình thức học quan tâm (educationLevel)' },
  { value: 'ethnicity', label: 'Dân tộc' },
  { value: 'permanentAddress', label: 'Địa chỉ thường trú' },
  { value: 'currentResidence', label: 'Nơi ở hiện tại' },
  ...
  { value: 'studyIntention', label: 'Hình thức học quan tâm (studyIntention)' },
