...
import { inferRuleCategory, legacyRulesToBlocks } from './scoring'
import { isGlobalScoringProfile } from './scoringProfileAccess'
...
export function mapScoringProfileDoc(id: string, data: Record<string, unknown>): ScoringProfile | null {
  try {
